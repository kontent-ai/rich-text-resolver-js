...
import { PortableTextImage, PortableTextTable, transformToPortableText } from "@kontent-ai/rich-text-resolver";
import { resolveImage, resolveTable } from "../src/index.js";
