...
import { flatten, nodeParse, resolveTable, transformToPortableText } from "../../../src";
...
describe("portable text transformer", () => {
  ...
  it("flattens html to block array", () => {
    const tree = nodeParse(dummyRichText.value)
    const result = flatten(tree.children);
...
[
  ...
  },
  {
    ...
    "_type": "span",
    "marks": [],
    "text": "The coffee drinking culture has been evolving for hundreds and thousands of years. It has never been ",
  },
  {
    "_key": "guid",
    "_type": "internalLink",
  ...
  },
  {
    ...
    "_type": "span",
    "marks": [],
    "text": ". How do you make sense of different types of coffee, what do the particular names in beverage menus mean and what beverage to choose for which occasion in your favorite café?",
  },
]
`);
  })
